<template>
    <div>
        <div class="hero">
          <v-toolbar style="height:82px;display: fixed;background-color: transparent;box-shadow:none">
            <div style="position: absolute;top: 34px;right: 0px; margin-right: 16px;height: 78px;">
          ...
          <div class="title-container">
            ...
            <div class="title">
              <v-img src="../../images/welcome.png" height="50px" width="300px"></v-img>
        ...
        <div class="about container" style="margin-bottom: 0px; padding-bottom: 0px;">
          <div class="text-one">
            <div class="card-title" style="justify-content: space-between;">
              <h1 class="text-h5" style="color: rgb(24, 78, 129); font-weight: bold;"><span>I</span>ntroduction </h1>
            </div>
          ...
          <div class="text-one">
            <div class="card-title" style="justify-content: space-between;cursor: pointer;" @click="toNews">
              <h1 class="text-h5" style="color: rgb(24, 78, 129); font-weight: bold;"><span>N</span>ews</h1>
              <h3 style="font-size: 16px;">MORE</h3>
            </div>
            <hr style="margin-top: 0px">
            <v-timeline :dense="true" :light="true" class="pt-3">
              <v-timeline-item small class="pb-3">
              ...
              <v-timeline-item color="cyan" small class="pb-3">
                <v-card class="pt-2 pb-2 pl-4 pr-4">
                  <v-card-text>
                    <span class="font-weight-bold text-body-1 mr-3 cyan--text">
                      2022-07
                    </span>
                    <span class="text--primary text-body-1 link_title">
                      Congratulations to xxx's paper accepted by xxx!
              ...
              <v-timeline-item color="red" small class="pb-3">
                <v-card class="pt-2 pb-2 pl-4 pr-4">
                  <v-card-text>
                    <span class="font-weight-bold text-body-1 mr-3 red--text">
                      2022-07
                    </span>
                    <span class="text--primary text-body-1 link_title">
                      Congratulations to xxx's paper accepted by xxx!
              ...
              <v-timeline-item color="pink" small class="pb-3">
                <v-card class="pt-2 pb-2 pl-4 pr-4">
                  <v-card-text>
                    <span class="font-weight-bold text-body-1 mr-3 pink--text">
                      2022-05
                    </span>
                    <span class="text--primary text-body-1 link_title">
                      Congratulations to xxx's paper accepted by xxx!
              ...
              <v-timeline-item color="purple lighten-2" small class="pb-3">
                <v-card class="pt-2 pb-2 pl-4 pr-4">
                  <v-card-text>
                    <span class="font-weight-bold text-body-1 mr-3 purple--text">
                      2022-01
                    </span>
                    <span class="text--primary text-body-1 link_title">
                      Congratulations to xxx's paper accepted by xxx!
        ...
        <div class="about_research container">
          <div class="card-title" style="justify-content: space-between;cursor: pointer;" @click="toSearch">
            <h1 class="text-h5" style="color: rgb(24, 78, 129); font-weight: bold;"><span>R</span>esearch</h1>
            <h3 style="font-size: 16px;">MORE</h3>
          </div>
          <hr style="margin-top: 0px">
          <div style="display: flex; flex-direction: row; justify-content: space-between;">
            <div class="mt-8 mb-8" style="display: flex;flex-direction: column;width: 33%;">
              <div class="ml-4 mr-4 mr-xl-8" style="flex-shrink: 0; min-height: 264px;">
                <h1 class="text-h5" style="color: rgb(0, 120, 215);">Medical image segmentation</h1>
                <v-list>
                  <v-list-item-group>
                    <v-list-item class="mb4" to="/Search/MIS">
                      <v-icon style="font-size: 16px" class="notranslate mr-2 mdi">mdi-square</v-icon>
                      <v-list-item-title class="text-h6">xxxx</v-list-item-title>
                    </v-list-item>
                    <v-list-item class="mb4" to="/en/Research/MIS">
                      <v-icon style="font-size: 16px" class="notranslate mr-2 mdi">mdi-square</v-icon>
                      <v-list-item-title class="text-h6">xxxx</v-list-item-title>
                    </v-list-item>
                    <v-list-item class="mb4" to="/en/Research/MIS">
            ...
            <div class="mt-8 mb-8" style="display: flex;flex-direction: column;width: 30%;">
              <div class="ml-4 mr-4 mr-xl-8" style="flex-shrink: 0; min-height: 264px;">
                <h1 class="text-h5" style="color: rgb(229, 89, 52);">Disease diagnosis</h1>
                <v-list>
                  <v-list-item-group>
                    <v-list-item class="mb4" to="/en/Research/DD">
                      <v-icon style="font-size: 16px" class="notranslate mr-2 mdi">mdi-square</v-icon>
                      <v-list-item-title class="text-h6">xxx</v-list-item-title>
                    </v-list-item>
                    <v-list-item class="mb4" to="/en/Research/DD">
                      <v-icon style="font-size: 16px" class="notranslate mr-2 mdi">mdi-square</v-icon>
                      <v-list-item-title class="text-h6">xxx</v-list-item-title>
            ...
            <div class="mt-8 mb-8" style="display: flex;flex-direction: column;width: 30%;">
              <div class="ml-4 mr-4 mr-xl-8" style="flex-shrink: 0; min-height: 264px;">
                <h1 class="text-h5" style="color: rgb(118, 77, 195);">Medical object detection</h1>
                <v-list>
                  <v-list-item-group>
                    <v-list-item class="mb4" to="/en/Research/OD">
                      <v-icon style="font-size: 16px" class="notranslate mr-2 mdi">mdi-square</v-icon>
                      <v-list-item-title class="text-h6">xxxx</v-list-item-title>
                    </v-list-item>
                  </v-list-item-group>
        ...
        <div class="about container" style="padding-top: 0px;">
          <div class="text-one">
            <div class="card-title pb-1 mt-16" style="justify-content: space-between;">
              <h1 class="text-h5" style="color: rgb(24, 78, 129); font-weight: bold;"><span>A</span>ctivities</h1>
            </div>
            <hr style="margin-top: 0px">        
            <v-carousel
              cycle
          ...
          <div class="text-one">
            <div class="card-title pb-1 mt-16" style="justify-content: space-between;">
              <h1 class="text-h5" style="color: rgb(24, 78, 129); font-weight: bold;"><span>C</span>ooperation</h1>
            </div>
            <hr style="margin-top: 0px">        
            <v-carousel
              cycle
    ...
    * {
    ...
    .hero {
      ...
      min-height: 300px;
      height: 420px;
      background-image: linear-gradient(to right top, rgba(255, 255, 255, 0.5), rgba(255, 255, 255, 0.5)), url("../../images/bk.jpg");
